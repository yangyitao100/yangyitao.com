import{_ as n,o as s,c as a,f as e}from"./app.03bf752b.js";const t={},p=e(`<h1 id="_03-事件名注册" tabindex="-1"><a class="header-anchor" href="#_03-事件名注册" aria-hidden="true">#</a> 03.事件名注册</h1><h2 id="packages-react-dom-bindings-src-events-domplugineventsystem-js" tabindex="-1"><a class="header-anchor" href="#packages-react-dom-bindings-src-events-domplugineventsystem-js" aria-hidden="true">#</a> packages/react-dom-bindings/src/events/DOMPluginEventSystem.js</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> allNativeEvents <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./EventRegistry&#39;</span><span class="token punctuation">;</span>
