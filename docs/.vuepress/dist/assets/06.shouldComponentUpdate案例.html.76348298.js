import{_ as n,o as s,c as a,f as t}from"./app.4326c516.js";const p={},e=t(`<h1 id="_06-shouldcomponentupdate案例" tabindex="-1"><a class="header-anchor" href="#_06-shouldcomponentupdate案例" aria-hidden="true">#</a> 06.shouldComponentUpdate案例</h1><p>案例解释请观看视频，这里呈现相关代码：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
...
<span class="token keyword">class</span> <span class="token class-name">Clock</span> <span class="token keyword">extends</span> <span class="token class-name">React<span class="token punctuation">.</span>Component</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// https://reactjs.org/docs/react-component.html#shouldcomponentupdate</span>
  <span class="token comment">// 1.界面展示不受到props和state的变化的影响的时候使用</span>
  <span class="token comment">// 2.默认行为是返回true，也就是需要更新</span>
  <span class="token comment">// 3.该函数在render函数执行之前调用</span>
  <span class="token comment">// 4.初始化渲染，或者执行forceUpdate的时候，不会调用该函数</span>
  <span class="token comment">// 5.仅仅作为性能优化的手段，建议不手动编写，而是使用PureComponent</span>
  <span class="token comment">// 6.返回false，render和componentDidUpdate都不会执行</span>
  <span class="token function">shouldComponentUpdate</span><span class="token punctuation">(</span><span class="token parameter">nextProps<span class="token punctuation">,</span> nextState</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">///</span>
    <span class="token keyword">return</span> <span class="token boolean">false</span><span class="token comment">///</span>
