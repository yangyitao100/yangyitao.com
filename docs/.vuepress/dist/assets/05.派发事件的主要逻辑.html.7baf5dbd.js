import{_ as n,o as s,c as a,f as e}from"./app.d86bc82c.js";const t={},p=e(`<h1 id="_05-派发事件的主要逻辑" tabindex="-1"><a class="header-anchor" href="#_05-派发事件的主要逻辑" aria-hidden="true">#</a> 05.派发事件的主要逻辑</h1><h2 id="packages-react-dom-bindings-src-events-reactdomeventlistener-js" tabindex="-1"><a class="header-anchor" href="#packages-react-dom-bindings-src-events-reactdomeventlistener-js" aria-hidden="true">#</a> packages/react-dom-bindings/src/events/ReactDOMEventListener.js</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> getEventTarget <span class="token keyword">from</span> <span class="token string">&#39;./getEventTarget&#39;</span><span class="token punctuation">;</span>
