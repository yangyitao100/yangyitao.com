import{_ as n,o as s,c as a,f as t}from"./app.d90d410b.js";const e={},p=t(`<h1 id="_02-生命周期的内涵" tabindex="-1"><a class="header-anchor" href="#_02-生命周期的内涵" aria-hidden="true">#</a> 02.生命周期的内涵</h1><p>同学们好，我们经常听说一个词“生命周期函数”，要了解什么是生命周期函数，就必须了解什么是生命周期，进而搞清楚生命周期函数的本质。</p><p>我们查阅百度百科对生命周期有这样的解释：生命周期就是指一个对象的生老病死。在React的世界里，生命周期就是指组件的生老病死。也就是从虚拟DOM到真实DOM的初始化以及中途到更新到最后组件的销毁。而生命周期函数，就是在初始化渲染和更新渲染的各个不同阶段执行的函数。那怎么才能在不同阶段执行对应的函数呢？当然就是在到相应阶段调用特定的函数，所以生命周期函数的本质就是回调，我们来举一个小例子。</p><p>比如我们出生的时候要开始执行一个函数叫开启一辈子：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
