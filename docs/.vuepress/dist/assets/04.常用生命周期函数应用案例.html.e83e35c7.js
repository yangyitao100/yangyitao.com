import{_ as n,o as s,c as a,f as t}from"./app.18acec2c.js";const p={},e=t(`<h1 id="_04-常用生命周期函数应用案例" tabindex="-1"><a class="header-anchor" href="#_04-常用生命周期函数应用案例" aria-hidden="true">#</a> 04.常用生命周期函数应用案例</h1><p>案例解释请观看视频，这里呈现其代码：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//https://reactjs.org/docs/state-and-lifecycle.html#adding-lifecycle-methods-to-a-class</span>
