import{_ as n,o as s,c as a,f as e}from"./app.d86bc82c.js";const t={},p=e(`<h1 id="_04-createroot" tabindex="-1"><a class="header-anchor" href="#_04-createroot" aria-hidden="true">#</a> 04.createRoot</h1><p>同学们好，前面我们说本章的目标是实现初始化渲染，具体而言，这个初始化渲染过程完成后，可以在页面上渲染一个带有一定样式的字符串：</p><h2 id="index-html" tabindex="-1"><a class="header-anchor" href="#index-html" aria-hidden="true">#</a> index.html:</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createRoot <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;react-dom/client&#39;</span><span class="token punctuation">;</span>
