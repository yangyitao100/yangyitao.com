import{_ as n,o as s,c as a,f as e}from"./app.c996eb5c.js";const i={},l=e(`<h1 id="_03-并发渲染" tabindex="-1"><a class="header-anchor" href="#_03-并发渲染" aria-hidden="true">#</a> 03.并发渲染</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> scheduleSyncCallback<span class="token punctuation">,</span> flushSyncCallbacks <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./ReactFiberSyncTaskQueue&#39;</span><span class="token punctuation">;</span>
